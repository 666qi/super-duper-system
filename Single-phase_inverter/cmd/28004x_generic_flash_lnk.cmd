...
//   RAMM1_RSVD      : origin = 0x0007F8, length = 0x000008     /* Reserve and do not use for code as per the errata advisory "Memory: Prefetching Beyond Valid Memory" */
   ...
   RAMLS5      : origin = 0x00A800, length = 0x002000
   RAMLS6      : origin = 0x00C800, length = 0x002000
   RAMLS7      : origin = 0x00E800, length = 0x000800

   RAMGS0      : origin = 0x00F000, length = 0x002000
   RAMGS1      : origin = 0x011000, length = 0x002000
   RAMGS2      : origin = 0x013000, length = 0x002000
   RAMGS3      : origin = 0x015000, length = 0x001FF8
...
SECTIONS
{
   ...
   dclfuncs         : > FLASH_BANK0_SEC1,    PAGE = 0
